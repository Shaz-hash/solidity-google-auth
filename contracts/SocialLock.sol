...
contract SocialLock {
    ...
    function withdraw(
        ...
        require(
            ...
            "Not enough balance for this email"
        );
    ...
    function withdrawToken(
        ...
        // balance check
        require(
            tokenBalances[emailHash][address(token)] > 0,
            "No balance for this email"
        );
        require(
    ...
    function validateJwt(
        ...
        // string memory senderBase64 = string(abi.encodePacked(msg.sender))
        //     .encode();
        // console.log("senderBase64", senderBase64);
        // console.log("nonce", nonce);
        // require(
        //     senderBase64.strCompare(nonce) == 0,
        //     "Sender does not match nonce"
        // );

        //signature check

        uint result = message.pkcs1Sha256VerifyStr(
            signature,
            exponent,
            modulus
        );
